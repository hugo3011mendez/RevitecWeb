...
(function($) {
    ...
    $.fn.bsgdprcookies = function(options, event) {
        ...
        var settings = $.extend({
            ...
            expireDays: 30,
            moreLinkActive: true,
            moreLinkLabel: 'Más informacion..',
            moreLinkNewTab: true,
            moreLink: 'privacy-policy.php',
            acceptButtonLabel: 'Aceptar',
            cancelButtonLabel: 'Denegar',
            allowAdvancedOptions: false,
            advancedTitle: 'Selecciona los cookies que deseas aceptar',
            advancedAutoOpenDelay: 1000,
            advancedButtonLabel: 'Opciones',
            advancedCookiesToSelect: [
                ...
                {
                    name: 'preferences',
                    title: 'Preferencias del sitio',
                    description: 'Requerido para guardar las preferencias de su sitio, por ejemplo, recordando tu nombre de usuario etc.',
                    isFixed: false
                },
                {
                    name: 'analytics',
                    title: 'Analíticas',
                    description: 'Requerido para recopilar visitas al sitio, tipos de navegador, etc.',
                    isFixed: false
                },
                {
                    name: 'marketing',
                    title: 'Marketing',
                    description: 'Requerido para la comercialización, por ejemplo. boletines, redes sociales, etc',
                    isFixed: false
                }
            ],
            OnAccept: function() {}
...
// es este donde se añade el boton de cancelar
            ...
            // cuando pulsamos denegar y cerramos 

            $('body').on('click','#' + settings.id + '-cancel-btn', function(){
                DisposeModal(settings.id);
            });
