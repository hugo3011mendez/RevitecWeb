 ...
 * This component is designed to filter Matches data.
...
export default function DataTable(props) {
    ...
    const filteredItems = props.data.filter(
        item => item.player1 && (item.player1.toLowerCase().includes(filterText.toLowerCase()) || item.player2.toLowerCase().includes(filterText.toLowerCase())),
    );
    ...
    return (
        <ReactDataTable
            ...
            highlightOnHover
            noDataComponent="No hay partidos que mostrar"
            ...
            paginationRowsPerPageOptions={[4, 8, 10, 16, 30, 50]}
