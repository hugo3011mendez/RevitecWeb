 ...
 * This component is designed to filter Messages data.
...
export default function DataTable(props) {
    ...
    const filteredItems = props.data.filter(
        item => item.title && (item.title.toLowerCase().includes(filterText.toLowerCase()) || item.text.toLowerCase().includes(filterText.toLowerCase())),
    );
    ...
    return (
        <ReactDataTable
            ...
            highlightOnHover
            noDataComponent="No hay alertas que mostrar"
